...
api: str = '7450975262:AAHfn8KrP5rP9PbEx8HH-EA_G2rT9vqxsbc'  # token to access the HTTP API
bot: Bot = Bot(token=api)
dp: Dispatcher = Dispatcher(bot, storage=MemoryStorage())

# клавиатура
kb: ReplyKeyboardMarkup = ReplyKeyboardMarkup(resize_keyboard=True)  # объект клавиатуры
kb.add(KeyboardButton(text='Рассчитать'),
       KeyboardButton(text='Информация'))  # добавление кнопок в клавиатуру (n-элементов в строке)
...
# РАСЧЕТ КАЛОРИЙ ------------------------------------------------------------------------------------------------- *
# выполнение функции только при получении сообщения 'Рассчитать'
